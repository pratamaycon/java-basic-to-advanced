...
public class FormularioAlteracao {
	public static void viewAlteracao(Long codigo) {

		// instanciar um obj da classe Jframe
		JFrame form = new JFrame("Alteracao de Notas");
		/**
		...
		Aluno aluno = alunoController.selecionarAluno(codigo);
		...
		campo1.setText(String.valueOf(aluno.getNota1()));
		...
		campo2.setText(String.valueOf(aluno.getNota2()));
		...
		campo3.setText(String.valueOf(aluno.getNota3()));
		...
		botao.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Aluno alunoModel = dados(nome, nota1, nota2, nota3, codigo);
				alunoController.atualizar(alunoModel);
	...
	public static Aluno dados(String nome, Double nota1, Double nota2, Double nota3, Long codigo) {
