...
public class SelecaoAlunosExclusao {

	public static void viewSelecaoAlunosExclusao() {
		JFrame selecaoAlunos = new JFrame("Exclusao de alunos");
		...
		combo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				AlunoController alunoController = new AlunoController();
				alunoController.remover(codigo);
